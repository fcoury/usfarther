curl 'https://uscloser.com/api/gravapedido' \
  -H 'Connection: keep-alive' \
  -H 'sec-ch-ua: " Not;A Brand";v="99", "Google Chrome";v="91", "Chromium";v="91"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'Security-Token: eHBiTWZvWVROc2RlQm04N2VGNWpzZz09' \
  ...
  -H 'Origem: App-web' \
  -H 'Auth-Token: czBpWjNudWZKTUVSSnhyOXo4WEtnbVdMSWF2Rm1nYVpORmlMd0FVVE1aeWFvOWJMWGp4Kzh0WE1oeUlEcmM3Rg==' \
  -H 'Origin: https://minhaconta.uscloser.com' \
  -H 'Sec-Fetch-Site: same-site' \
  -H 'Sec-Fetch-Mode: cors' \
  -H 'Sec-Fetch-Dest: empty' \
  -H 'Referer: https://minhaconta.uscloser.com/' \
